...
class string_operations:
        def _get_the_central_key(string:str=None, slicenum_front:int=20, slicenum_back:int=20):
                if string is None:
                    return None
...
print(decrypt._get_collective_alphabet(encrypt._get_collective_alphabet_key("BARK")))